   ...
   Example call:
    ...
    for i in range(Nband):
        ...
        for j in range(nframes):
            signal_power = (np.linalg.norm(x_magsm[start:stop, j], 2) ** 2)/(frmelen*U) # the term frmlem*U may not be neccessary as they cancel out (snr). It only matters if computing absolute power values, not ratios.
...
if __name__ == "__main__":
    ...
    noise_path = Path(r"C:\\Users\\gabi\\Documents\\University\\Uni2025\\Investigation\\PROJECT-25P85\\src\\deep_learning\\gtcrn_model\\test_wavs\\enh_noisy_input2.wav")
    ...
    mband(
        ...
        output_file="mband_gtcrn_noisy_input2.wav",

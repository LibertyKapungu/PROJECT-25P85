...
results_dir = repo_root / 'results' / 'EXP3' / 'tinydenoiser' / 'SSTD_EXP3p1b'
...
for snr_dB in snr_dB_range:
    ...
    for noise_path, clean_path in paired_files:
        ...
        output_filename = f"SSTD_{clean_filename}_{noise_filename}_SNR[{snr_dB}]dB.wav"
        ...
        metrics = compute_and_save_speech_metrics(
            ...
            csv_filename='SSTD_EXP3p1b_data'
        )
    ...
    merged_path = merge_csvs(
        ...
        output_filename=f'SSTD_EXP3p1b_merged_[{snr_dB}]dB.csv',
        keep_source=True
    )

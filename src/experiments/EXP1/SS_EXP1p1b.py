...
output_dir = repo_root / 'sound_data' / 'processed' / 'spectral_processed_outputs' / 'EXP1p1b_output' 
results_dir = repo_root / 'results' / 'EXP1' / 'spectral' / 'SS_EXP1p1b'

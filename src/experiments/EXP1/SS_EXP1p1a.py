...
"""
Experiment EXP1p1a: Python mband Implementation Test
- Tests the Python translation of the mband algorithm.
- Compares causal (AVRGING=0) vs. non-causal (AVRGING=1).
...
results_dir_base = repo_root / 'results' / 'EXP1' / 'spectral' / 'SS_EXP1p1a_Python_mband_Test'
...
from dsp_algorithms.spectral.mband_non_causal_translation import mband

...
output_dir = repo_root / 'sound_data' / 'processed' / 'wiener_processed_outputs' / 'EXP1p1c_output' 
results_dir = repo_root / 'results' / 'EXP1' / 'wiener' / 'WF_EXP1p1c'
...
for snr_dB in snr_dB_range:
    ...
    merged_path = merge_csvs(
        ...
        output_filename=f'WF_EXP1p1c_merged_[{snr_dB}]dB.csv',
        keep_source=True
    )

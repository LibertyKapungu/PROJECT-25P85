...
results_dir = repo_root / 'results' / 'EXP2' / 'spectral' / 'SS_EXP2p1a'
...
from deep_learning.mband_gru import mband
    ...
    for snr_dB in snr_dB_range:
        ...
        for noise_path, clean_path in paired_files:
            ...
            metrics = compute_and_save_speech_metrics(
                ...
                csv_filename=f'SS_EXP2.1a_data_SNR[{snr_dB}]dB_THRESH[{threshold:.2f}]'
            )

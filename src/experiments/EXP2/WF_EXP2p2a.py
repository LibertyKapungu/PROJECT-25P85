...
results_dir = repo_root / 'results' / 'EXP2' / 'wiener' / 'WF_EXP2p2a'
...
from hybrid_algorithms.wiener_Marblenet import wiener_filter
...
for snr_dB in snr_dB_range:
    ...
    merged_path = merge_csvs(
        ...
        output_filename=f'WF_EXP2p2a_merged_[{snr_dB}]dB.csv',
        keep_source=True
    )

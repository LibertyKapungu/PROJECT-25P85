% =========================================================================
% Run Metrics for Wiener_as Python Translation Algorithm
% =========================================================================
% This script evaluates Wiener-processed speech against clean reference S_56_02.wav
% -------------------------------------------------------------------------

% --- Add metric subfolders to MATLAB path ---
addpath(genpath('objective_metrics/'));
addpath(genpath('validation_dataset/'));
addpath(genpath('python_wiener_processed_output/'))

% --- Reference files ---
ref_clean_speech_wiener = 'validation_dataset/clean_speech/S_56_02.wav'; % Clean reference for Wiener-processed files

% =========================================================================
% Evaluate Wiener-processed files against S_56_02.wav
% =========================================================================
fprintf('=== SCENARIO 1: Evaluating Wiener-processed files ===\n');

wiener_processed_directory = 'python_wiener_processed_output/';
